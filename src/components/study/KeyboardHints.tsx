  ...
  return (
    <div className="mt-8 pt-6 border-t border-gray-200">
      <p className="text-xs text-gray-500 text-center">
        ...
        {!isRevealed ? (
          <span>
            <kbd className="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs">Spacja</kbd> lub{" "}
            <kbd className="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs">Enter</kbd> - pokaż odpowiedź
          </span>
        ) : (
          <span>
